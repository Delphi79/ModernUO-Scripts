...
{
	public class AddGearGump : Gump
	{
		public static void Initialize()
		{
				CommandSystem.Register("AddGearStatic", AccessLevel.GameMaster, new CommandEventHandler(AddGear_OnCommand));
		}
        private static void OnLogin(CommandEventArgs e)
        {
            Mobile from = e.Mobile;
            from.CloseGump<AddGearGump>();
            from.SendGump(new AddGearGump(from));
        }
        private static void AddGear_OnCommand(CommandEventArgs e)
        {
	        Mobile from = e.Mobile;
	        from.CloseGump<AddGearGump>();
            from.SendGump(new AddGearGump(from));
		...
		public AddGearGump(Mobile from): base(0, 0)
		{
			...
			AddHtml(330, 160, 211, 31, "<basefont size=5><center>Gear", false, false);
		 ...
		 public override void OnResponse(NetState sender, in RelayInfo info)
        {
            ...
            switch(info.ButtonID)
            {
				case 1:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt1", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 2:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt2", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                 case 3:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt3", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                 case 4:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt4", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                 case 5:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt5", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
               /* case 6:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt6", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 7:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt7", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 8:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt8", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 9:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt9", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                 case 10:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt10", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 11:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt11", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 12:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt12", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 13:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt13", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 14:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt14", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 15:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt15", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 16:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt16", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 17:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt17", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 18:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt18", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 19:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt19", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}
                case 20:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGearPt20", prefix));
                    from.SendGump(new AddGearGump(from));
                    break;
				}*/
