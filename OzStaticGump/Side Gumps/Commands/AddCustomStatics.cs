...
{
	public class AddCustomGump : Gump
	{
		public static void Initialize()
		{
				CommandSystem.Register("AddCustomsStatic", AccessLevel.GameMaster, new CommandEventHandler(AddCustomsStatic));
		}
        private static void OnLogin(CommandEventArgs e)
        {
            Mobile from = e.Mobile;
            from.CloseGump<AddCustomGump>();
            from.SendGump(new AddCustomGump(from));
        }
        private static void AddCustomsStatic(CommandEventArgs e)
        {
	        Mobile from = e.Mobile;
	        from.CloseGump<AddCustomGump>();
            from.SendGump(new AddCustomGump(from));
		...
		public AddCustomGump(Mobile from): base(0, 0)
		{
			...
			AddHtml(330, 160, 211, 31, "<basefont size=5><center>Customs", false, false);
		 ...
		 public override void OnResponse(NetState sender, in RelayInfo info)
        {
            ...
            switch(info.ButtonID)
            {
				case 1:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt1", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 2:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt2", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                 case 3:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt3", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                 case 4:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt4", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                 case 5:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt5", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                 case 6:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt6", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 7:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt7", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                 case 8:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt8", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 9:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt9", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                 case 10:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt10", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 11:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt11", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 12:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt12", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 13:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt13", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 14:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt14", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 15:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt15", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 16:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt16", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 17:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt17", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 18:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt18", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 19:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt19", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
                case 20:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddCustomPt20", prefix));
                    from.SendGump(new AddCustomGump(from));
                    break;
				}
