...
{
	public class AddAnimationStaticGump : Gump
	{
		public static void Initialize()
		{
				CommandSystem.Register("AddAnimationStatic", AccessLevel.GameMaster, new CommandEventHandler(AddAnimationStatic));
		}
        private static void OnLogin(CommandEventArgs e)
        {
            Mobile from = e.Mobile;
            from.CloseGump<AddAnimationStaticGump>();
            from.SendGump(new AddAnimationStaticGump(from));
        }
        private static void AddAnimationStatic(CommandEventArgs e)
        {
	        Mobile from = e.Mobile;
	        from.CloseGump<AddAnimationStaticGump>();
            from.SendGump(new AddAnimationStaticGump(from));
		...
		public AddAnimationStaticGump(Mobile from): base(0, 0)
		{
			...
			AddHtml(330, 160, 211, 31, "<basefont size=5><center>Animations", false, false);
		 ...
		 public override void OnResponse(NetState sender, in RelayInfo info)
        {
            ...
            switch(info.ButtonID)
            {
				case 1:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt1", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 2:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt2", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                 case 3:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt3", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                 case 4:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt4", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                 case 5:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt5", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                /* case 6:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt6", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                 case 7:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt7", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                 case 8:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt8", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 9:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt9", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                 case 10:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt10", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 11:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt11", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 12:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt12", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 13:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt13", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 14:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt14", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 15:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt15", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 16:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt16", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 17:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt17", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 18:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt18", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 19:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt19", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}
                case 20:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddAnimStPt20", prefix));
                    from.SendGump(new AddAnimationStaticGump(from));
                    break;
				}*/
