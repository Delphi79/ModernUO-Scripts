...
namespace Server.Gumps
{
	public class AddFloorGump : Gump
	{
		...
		{
				CommandSystem.Register("AddFloor", AccessLevel.GameMaster, new CommandEventHandler(AddFloor));
		}
        private static void OnLogin(CommandEventArgs e)
        {
            Mobile from = e.Mobile;
            from.CloseGump<AddFloorGump>();
            from.SendGump(new AddFloorGump(from));
        }
        private static void AddFloor(CommandEventArgs e)
        {
	        Mobile from = e.Mobile;
	        from.CloseGump<AddFloorGump>();
            from.SendGump(new AddFloorGump(from));
		...
		public AddFloorGump(Mobile from): base(0, 0)
		{
			...
			AddHtml(330, 160, 211, 31, "<basefont size=5><center>Floor", false, false);
		 ...
		 public override void OnResponse(NetState sender, in RelayInfo info)
        {
            ...
            switch(info.ButtonID)
            {
				case 1:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt1", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 2:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt2", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                 case 3:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt3", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                 case 4:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt4", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                 case 5:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt5", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                 case 6:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt6", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                 case 7:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt7", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                 case 8:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt8", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                /*case 9:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt9", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                 case 10:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt10", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 11:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt11", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 12:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt12", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 13:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt13", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 14:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt14", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 15:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt15", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 16:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt16", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 17:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt17", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 18:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt18", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 19:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt19", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}
                case 20:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddFloorPt20", prefix));
                    from.SendGump(new AddFloorGump(from));
                    break;
				}*/
