...
{
	public class AddGroundStGump : Gump
	{
		public static void Initialize()
		{
				CommandSystem.Register("AddGroundSt", AccessLevel.GameMaster, new CommandEventHandler(AddGroundSt));
		}
        private static void OnLogin(CommandEventArgs e)
        {
            Mobile from = e.Mobile;
            from.CloseGump<AddGroundStGump>();
            from.SendGump(new AddGroundStGump(from));
        }
        private static void AddGroundSt(CommandEventArgs e)
        {
	        Mobile from = e.Mobile;
            from.CloseGump<AddGroundStGump>();
            from.SendGump(new AddGroundStGump(from));
		...
		public AddGroundStGump(Mobile from): base(0, 0)
		{
			...
			AddHtml(330, 160, 211, 31, "<basefont size=5><center>Ground", false, false);
		 ...
		 public override void OnResponse(NetState sender, in RelayInfo info)
        {
            ...
            switch(info.ButtonID)
            {
				case 1:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt1", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 2:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt2", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                 case 3:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt3", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                 case 4:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt4", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                 case 5:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt5", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                 /* case 6:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt6", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 7:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt7", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                 case 8:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt8", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 9:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt9", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                 case 10:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt10", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 11:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt11", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 12:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt12", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 13:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt13", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 14:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt14", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 15:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt15", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 16:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt16", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 17:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt17", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 18:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt18", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 19:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt19", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}
                case 20:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddGroundStPt20", prefix));
                    from.SendGump(new AddGroundStGump(from));
                    break;
				}*/
