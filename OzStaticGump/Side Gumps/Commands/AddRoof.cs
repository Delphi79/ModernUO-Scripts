...
namespace Server.Gumps
{
	public class AddRoofGump : Gump
	{
		...
		{
				CommandSystem.Register("AddRoof", AccessLevel.GameMaster, new CommandEventHandler(AddRoof_OnCommand));
		}
        private static void OnLogin(CommandEventArgs e)
        {
            Mobile from = e.Mobile;
            from.CloseGump<AddRoofGump>();
            from.SendGump(new AddRoofGump(from));
        }
        private static void AddRoof_OnCommand(CommandEventArgs e)
        {
	        Mobile from = e.Mobile;
	        from.CloseGump<AddRoofGump>();
            from.SendGump(new AddRoofGump(from));
		...
		public AddRoofGump(Mobile from): base(0, 0)
		{
			...
			AddHtml(330, 160, 211, 31, "<basefont size=5><center>Roofs", false, false);
		 ...
		 public override void OnResponse(NetState sender, in RelayInfo info)
        {
            ...
            switch(info.ButtonID)
            {
				case 1:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt1", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 2:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt2", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                 case 3:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt3", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                 case 4:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt4", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                  /*case 5:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt5", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                 case 6:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt6", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 7:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt7", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                 case 8:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt8", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 9:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt9", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                 case 10:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt10", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 11:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt11", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 12:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt12", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 13:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt13", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 14:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt14", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 15:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt15", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 16:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt16", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 17:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt17", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 18:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt18", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 19:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt19", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}
                case 20:
				{
                    CommandSystem.Handle(from, string.Format("{0}AddRoofPt20", prefix));
                    from.SendGump(new AddRoofGump(from));
                    break;
				}*/
