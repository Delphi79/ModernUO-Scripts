    ...
    public class ArrianasGump : Gump
    {
        ...
        public ArrianasGump( Mobile owner ) : base( 50,50 )
        {
            ...
            AddHtml( 107, 140, 300, 230, "<BODY>" +
                                         ...
                                         "<BASEFONT COLOR=YELLOW>My uncle has a farm somewhere in ...<BR><BR> hmmm, all i can remember is this phrase my mom told me.<BR>It's not where the sun dims but where the ...<BR><BR>" +
